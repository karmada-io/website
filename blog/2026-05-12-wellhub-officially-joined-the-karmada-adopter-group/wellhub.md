# Welcome Wellhub to the Karmada Adopter Group!

Karmada is thrilled to announce that **[Wellhub](https://wellhub.com/)**
...
environments. The joining of **Wellhub** will further strengthen the Karmada
...
![wellhub logo](../../static/img/supporters/wellhub.png)

Wellhub is on a mission to make every company a wellness company where employees
...
More than 19,000 companies in 11 countries use Wellhub to give their millions of
employees access to best-in-class corporate wellbeing programs that are proven to
drive widespread employee adoption and engagement.

Wellhub more than doubles the number of employees engaged with wellness. This
widespread participation results in workforces that are 40% less likely to turnover
and save their companies up to 35% on healthcare costs.
...
currently using Karmada in `production`. This includes:
