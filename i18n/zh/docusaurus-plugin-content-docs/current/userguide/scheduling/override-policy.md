...
### PlaintextOverrider
The `PlaintextOverrider` is a simple overrider that overrides target fields according to path, operator and value, just like `kubectl patch`. Its behavior follows the [RFC 6902 (JSON Patch)](https://datatracker.ietf.org/doc/html/rfc6902/) specification.
