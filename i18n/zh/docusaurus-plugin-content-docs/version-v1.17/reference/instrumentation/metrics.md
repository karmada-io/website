...
| cluster_ready_state                            | Gauge     | 集群的状态 (1 代表就绪, 0 代表其他)                                                                      | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_node_number                            | Gauge     | 集群中节点的数量                                                                                    | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_ready_node_number                      | Gauge     | 集群中就绪节点的数量                                                                                  | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_memory_allocatable_bytes               | Gauge     | 集群中可分配的内存资源 (单位字节)                                                                          | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_cpu_allocatable_number                 | Gauge     | 集群中可分配的 CPU 数量                                                                              | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_pod_allocatable_number                 | Gauge     | 集群中可分配的 Pod 数量                                                                              | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_memory_allocated_bytes                 | Gauge     | 集群中已分配的内存资源 (单位字节)                                                                          | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_cpu_allocated_number                   | Gauge     | 集群中已分配的 CPU 数量                                                                              | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_pod_allocated_number                   | Gauge     | 集群中已分配的 Pod 数量                                                                              | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
| cluster_sync_status_duration_seconds           | Histogram | 同步一次群集状态的持续时间 (单位秒)                                                                         | member_cluster                        | karmada-controller-manager<br/>karmada-agent |
...
| create_resource_to_cluster                     | Counter   | 在成员集群中创建资源的操作次数，"error" 代表创建资源失败，否则为 "success"                                             | result<br/>apiversion<br/>kind<br/>member_cluster<br/>recreate | karmada-controller-manager                   |
| update_resource_to_cluster                     | Counter   | 在成员集群中更新资源的操作次数，"error" 代表更新资源失败，否则为 "success"                                             | result<br/>apiversion<br/>kind<br/>member_cluster<br/>operationResult | karmada-controller-manager                   |
| delete_resource_from_cluster                   | Counter   | 在成员集群中删除资源的操作次数，"error" 代表删除资源失败，否则为 "success"                                             | result<br/>apiversion<br/>kind<br/>member_cluster | karmada-controller-manager                   |
| eviction_queue_depth                           | Gauge     | 驱逐队列的当前深度                                                                                   | name                                  | karmada-controller-manager                   |
| eviction_kind_total                            | Gauge     | 按资源类型统计的驱逐队列中的资源数量                                                                          | member_cluster<br/>resource_kind      | karmada-controller-manager                   |
| eviction_processing_latency_seconds            | Histogram | 处理驱逐任务的延迟 (单位秒)                                                                             | name                                  | karmada-controller-manager                   |
| eviction_processing_total                      | Counter   | 已处理的驱逐总数                                                                                    | name<br/>result                       | karmada-controller-manager                   |
