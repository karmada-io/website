...
![Karmada at ci123](adoptions-ci123-architecture.png "Karmada at ci123")
...
![Automatic cluster management](adoptions-ci123-automation-cluster-en.png "Automatic cluster management")
...
![MSP-Karmada integration-1](adoptions-ci123-msp-multicluster-1.png "MSP-Karmada integration-1")

![MSP-Karmada integration-2](adoptions-ci123-msp-multicluster-2.png "MSP-Karmada integration-2")
...
![Multi-cluster capabilities](adoptions-ci123-multicluster-capability.png "Multi-cluster capabilities")
...
3. 
   ![Capability visualization](adoptions-ci123-capability-visualization.png "Capability visualization")
...
![Capability visualization-1](adoptions-ci123-unified-view-1.png "Capability visualization-1")

![Capability visualization-2](adoptions-ci123-unified-view-2.png " Capability visualization-2")
...
3. The control plane runs a detector to collect, aggregate, and calculate the inspection results. Perceptible link states of member clusters allow more effective cross-cluster deployment and scheduling. The following figure shows the Cluster Inspection page in the online system.
   ...
   ![Cluster inspection](adoptions-ci123-cluster-inspection.png "Cluster inspection")
...
![Time sequence state](adoptions-ci123-sequence-status.png "Time sequence state")
...
![Time sequence state](adoptions-ci123-velero.png "Time sequence state")
...
![GPU resource management](adoptions-ci123-gpu-resources.png "GPU resource management")
